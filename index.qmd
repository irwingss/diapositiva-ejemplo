...
library(raster)
r <- raster("Penelope_albipennis_1_MRI-ESM2-0_ssp585_2081-2100.asc")
```
...
leaflet() %>%
  ...
  setView(lng = -78.7038, lat = -5.4168, zoom = 6) %>% 
...
![Loro loco](https://media.tenor.com/x-kqDAmw2NQAAAAM/parrot-party.gif)
